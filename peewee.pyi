...
class attrdict(dict):
    ...
    def __iadd__(self, rhs: Any) -> "attrdict": ...
    def __add__(self, rhs: Any) -> "attrdict": ...
...
class State:
    def __new__(cls, scope: Any = ..., parentheses: bool = ..., subquery: bool = ..., **kwargs: Any): ...
    def __call__(self, scope: Optional[Any] = ..., parentheses: Optional[Any] = ..., subquery: Optional[Any] = ..., **kwargs: Any): ...
...
class Source(Node):
    ...
    def join(self, dest: Any, join_type: str = ..., on: Optional[Any] = ...): ...
...
class CTE(_HashableSource, Source):
    def __init__(self, name: Any, query: Any, recursive: bool = ..., columns: Optional[Any] = ...) -> None: ...
...
class Function(ColumnBase):
    name: Any = ...
    arguments: Any = ...
    def __init__(self, name: Any, arguments: Any, coerce: bool = ...) -> None: ...
    def __getattr__(self, attr: Any): ...
    def filter(self, where: Optional[Any] = ...) -> None: ...
    def over(self, partition_by: Optional[Any] = ..., order_by: Optional[Any] = ..., start: Optional[Any] = ..., end: Optional[Any] = ..., frame_type: Optional[Any] = ..., window: Optional[Any] = ...): ...
    def __sql__(self, ctx: Any): ...
...
class Window(Node):
    ...
    frame_type: Any = ...
    def __init__(self, partition_by: Optional[Any] = ..., order_by: Optional[Any] = ..., start: Optional[Any] = ..., end: Optional[Any] = ..., frame_type: Optional[Any] = ..., alias: Optional[Any] = ...) -> None: ...
    def alias(self, alias: Optional[Any] = ...): ...
...
class OnConflict(Node):
    def __init__(self, action: Optional[Any] = ..., update: Optional[Any] = ..., preserve: Optional[Any] = ..., where: Optional[Any] = ..., conflict_target: Optional[Any] = ...) -> None: ...
    def get_conflict_statement(self, ctx: Any): ...
    def get_conflict_update(self, ctx: Any): ...
...
class Select(SelectBase):
    def __init__(self, from_list: Optional[Any] = ..., columns: Optional[Any] = ..., group_by: Optional[Any] = ..., having: Optional[Any] = ..., distinct: Optional[Any] = ..., windows: Optional[Any] = ..., for_update: Optional[Any] = ..., **kwargs: Any) -> None: ...
    def clone(self): ...
    def columns(self, *columns: Any, **kwargs: Any) -> None: ...
    select: Any = ...
    def select_extend(self, *columns: Any) -> None: ...
    def from_(self, *sources: Any) -> None: ...
    def join(self, dest: Any, join_type: str = ..., on: Optional[Any] = ...) -> None: ...
    ...
    def for_update(self, for_update: bool = ...) -> None: ...
...
class Database(_callable_context_manager):
    ...
    quote: str = ...
    commit_select: bool = ...
    compound_select_parentheses: bool = ...
    for_update: bool = ...
    ...
    thread_safe: Any = ...
    connect_params: Any = ...
    def __init__(self, database: Any, thread_safe: bool = ..., autorollback: bool = ..., field_types: Optional[Any] = ..., operations: Optional[Any] = ..., autocommit: Optional[Any] = ..., **kwargs: Any) -> None: ...
    database: Any = ...
    deferred: Any = ...
    ...
    def conflict_statement(self, on_conflict: Any) -> None: ...
    def conflict_update(self, on_conflict: Any) -> None: ...
...
class SqliteDatabase(Database):
    ...
    def atomic(self, lock_type: Optional[Any] = ...): ...
    def transaction(self, lock_type: Optional[Any] = ...): ...
    ...
    def conflict_statement(self, on_conflict: Any): ...
    def conflict_update(self, on_conflict: Any): ...
...
class PostgresqlDatabase(Database):
    ...
    safe_create_index: bool = ...
    sequences: bool = ...
    def init(self, database: Any, register_unicode: bool = ..., encoding: Optional[Any] = ..., **kwargs: Any) -> None: ...
    def set_server_version(self, version: Any) -> None: ...
    def last_insert_id(self, cursor: Any, query_type: Optional[Any] = ...): ...
    def get_tables(self, schema: Optional[Any] = ...): ...
    def get_views(self, schema: Optional[Any] = ...): ...
    def get_indexes(self, table: Any, schema: Optional[Any] = ...): ...
...
class _atomic(_callable_context_manager):
    db: Any = ...
    def __init__(self, db: Any, lock_type: Optional[Any] = ...) -> None: ...
    def __enter__(self): ...
...
class ForeignKeyField(Field):
    ...
    deferred: Any = ...
    object_id_name: Any = ...
    def __init__(self, model: Any, field: Optional[Any] = ..., backref: Optional[Any] = ..., on_delete: Optional[Any] = ..., on_update: Optional[Any] = ..., deferrable: Optional[Any] = ..., _deferred: Optional[Any] = ..., rel_model: Optional[Any] = ..., to_field: Optional[Any] = ..., object_id_name: Optional[Any] = ..., related_name: Optional[Any] = ..., *args: Any, **kwargs: Any) -> None: ...
    @property
    def field_type(self): ...
    def get_modifiers(self): ...
    def adapt(self, value: Any): ...
...
class ManyToManyField(MetaField):
    ...
    backref: Any = ...
    through_model: Any = ...
    def __init__(self, model: Any, backref: Optional[Any] = ..., through_model: Optional[Any] = ..., _is_backref: bool = ...) -> None: ...
    def bind(self, model: Any, name: Any, set_attribute: bool = ...): ...
    def get_models(self): ...
...
class Metadata:
    ...
    manytomany: Any = ...
    options: Any = ...
    def __init__(self, model: Any, database: Optional[Any] = ..., table_name: Optional[Any] = ..., indexes: Optional[Any] = ..., primary_key: Optional[Any] = ..., constraints: Optional[Any] = ..., schema: Optional[Any] = ..., only_save_dirty: bool = ..., table_alias: Optional[Any] = ..., depends_on: Optional[Any] = ..., options: Optional[Any] = ..., db_table: Optional[Any] = ..., table_function: Optional[Any] = ..., without_rowid: bool = ..., temporary: bool = ..., legacy_table_names: bool = ..., **kwargs: Any) -> None: ...
    ...
    def remove_field(self, field_name: Any): ...
    auto_increment: Any = ...
...
class Model:
    ...
    @classmethod
    def create_table(cls, safe: bool = ..., **options: Any): ...
    @classmethod
    def drop_table(cls, safe: bool = ..., drop_sequences: bool = ..., **options: Any): ...
    @classmethod
...
class ModelSelect(BaseModelSelect, Select):
    ...
    def join(self, dest: Any, join_type: str = ..., on: Optional[Any] = ..., src: Optional[Any] = ..., attr: Optional[Any] = ...) -> None: ...
    def join_from(self, src: Any, dest: Any, join_type: str = ..., on: Optional[Any] = ..., attr: Optional[Any] = ...): ...
...
class ManyToManyQuery(ModelSelect):
    ...
    def add(self, value: Any, clear_existing: bool = ...): ...
